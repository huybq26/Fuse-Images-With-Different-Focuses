var dfjs = (function (exports) {
  ...
  _export(
    { target: 'Date', proto: true, forced: FORCED$2 },
    {
  ...
  function createIterGenerator(data, func) {
    ...
    return regeneratorRuntime.wrap(
      function createIterGenerator$(_context2) {
        while (1) {
  ...
  function chain(data) {
    for (
      var _len = arguments.length,
        operations = new Array(_len > 1 ? _len - 1 : 0),
        _key = 1;
      _key < _len;
      _key++
    ) {
  ...
  function xSplit(stringToSplit) {
    for (
      var _len2 = arguments.length,
        patterns = new Array(_len2 > 1 ? _len2 - 1 : 0),
        _key2 = 1;
      _key2 < _len2;
      _key2++
    ) {
  ...
  function xContains(stringToFilter) {
    for (
      var _len4 = arguments.length,
        patterns = new Array(_len4 > 1 ? _len4 - 1 : 0),
        _key4 = 1;
      _key4 < _len4;
      _key4++
    ) {
    ...
    (function (_Error) {
      ...
      function FileNotFoundError(fileName) {
        ...
        _this = _possibleConstructorReturn(
          this,
          _getPrototypeOf(FileNotFoundError).call(this, Error)
        );
        _this.message = ''.concat(
          fileName,
          ' not found. You maybe use a wrong path or url. Be sure you use absolute path, relative one being not supported.'
        );
    ...
    (function (_TypeError) {
      ...
      function MixedTypeError() {
        ...
        _this2 = _possibleConstructorReturn(
          this,
          _getPrototypeOf(MixedTypeError).call(this, TypeError)
        );
        ...
        _this2.message = "can't work with multiple variable types: [".concat(
          types.join(','),
          '].'
        );
    ...
    (function (_Error2) {
      ...
      function NoSuchColumnError(column, columns) {
        ...
        _this3 = _possibleConstructorReturn(
          this,
          _getPrototypeOf(NoSuchColumnError).call(this, Error)
        );
        _this3.message = ''
          .concat(column, ' not found in [')
          .concat(columns.join(', '), '].');
    ...
    (function (_Error3) {
      ...
      function WrongSchemaError(columns, expected) {
        ...
        _this4 = _possibleConstructorReturn(
          this,
          _getPrototypeOf(WrongSchemaError).call(this, Error)
        );
        _this4.message = '['
          .concat(columns.join(', '), '] while expecting [')
    ...
    (function (_TypeError2) {
      ...
      function ArgumentTypeError(input, expected) {
        ...
        _this5 = _possibleConstructorReturn(
          this,
          _getPrototypeOf(ArgumentTypeError).call(this, TypeError)
        );
        _this5.message = ''
          .concat(
    ...
    (function (_Error4) {
      ...
      function SQLParseError(message) {
        ...
        _this6 = _possibleConstructorReturn(
          this,
          _getPrototypeOf(SQLParseError).call(this, Error)
        );
    ...
    (function (_Error5) {
      ...
      function TableAlreadyExistsError(tableName) {
        ...
        _this7 = _possibleConstructorReturn(
          this,
          _getPrototypeOf(TableAlreadyExistsError).call(this, Error)
        );
        _this7.message = 'The SQL temporary table '.concat(
          tableName,
          ' already exits. Use overwrite = true to overwrite it.'
        );
    ...
    (function (_Error6) {
      ...
      function WrongTableNameError(tableName) {
        ...
        _this8 = _possibleConstructorReturn(
          this,
          _getPrototypeOf(WrongTableNameError).call(this, Error)
        );
        _this8.message = 'The SQL temporary table '.concat(
          tableName,
          ' is not allowed. Avoid to use Spaces, quotes, tabs....'
        );
                ...
                function value$(_context) {
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        (_i = 0),
                          (_Object$values = Object.values(this[__values__]));
        ...
        },
        {
          ...
          value: function __newInstance__(data, columns) {
            ...
            return Object.assign(
              ...
              this,
              ((_Object$assign = {}),
              _defineProperty(_Object$assign, __values__, data),
              _defineProperty(
                _Object$assign,
                __columns__,
        ...
        },
        {
          ...
          value: function _fromObject(object) {
            return Object.assign.apply(
              ...
              [{}].concat(
                _toConsumableArray(
                  this[__columns__].map(function (column) {
        ...
        },
        {
          ...
          value: function _fromArray(array) {
            return Object.assign.apply(
              ...
              [{}].concat(
                _toConsumableArray(
                  Object.entries(this[__columns__]).map(function (column) {
        ...
        },
        {
          ...
          value: function set(columnToSet, value) {
            var newRow = Object.assign(
              {},
              this[__values__],
              _defineProperty({}, columnToSet, value)
            );
      ...
      _createClass(GroupedDataFrame, [
        ...
        },
        {
          ...
          value: function filter(condition) {
            ...
            var mapped = _toConsumableArray(this)
              .map(function (_ref5) {
          ...
          value: function aggregate(func) {
            var columnName =
              arguments.length > 1 && arguments[1] !== undefined
                ...
                : 'aggregation';
            return this.df.__newInstance__(
              _toConsumableArray(this).map(function (_ref9) {
                var group = _ref9.group,
                  groupKey = _ref9.groupKey;
                return _objectSpread2(
                  {},
                  groupKey,
                  _defineProperty({}, columnName, func(group, groupKey))
                );
              }),
        ...
        },
        {
          ...
          value: function pivot(columnToPivot) {
            ...
            var columns = [].concat(
              _toConsumableArray(this.on),
              _toConsumableArray(
                this.df.distinct(columnToPivot).toArray(columnToPivot)
              )
            );
            return this.df.__newInstance__(
              this.aggregate(function (group) {
                return group
                  .groupBy(columnToPivot)
                  .aggregate(function (gp, gk) {
          ...
          value: function melt() {
            ...
            var valueColumnName =
              arguments.length > 1 && arguments[1] !== undefined
                ? arguments[1]
                : 'value';
            var columns = [].concat(_toConsumableArray(this.on), [
              variableColumnName,
              valueColumnName,
            ]);
            return this.df.__newInstance__(
              this.aggregate(function (group) {
                return Object.entries(group.toDict()).reduce(function (
                  tidy,
                  _ref12
                ) {
                  ...
                  return [].concat(
                    _toConsumableArray(tidy),
                    _toConsumableArray(
                      value.reduce(function (p, n) {
                        var _ref14;

                        return !_this.on.includes(key)
                          ? [].concat(_toConsumableArray(p), [
                              ((_ref14 = {}),
                              _defineProperty(_ref14, variableColumnName, key),
                              _defineProperty(_ref14, valueColumnName, n),
                              _ref14),
                            ])
                          : p;
                      }, [])
  ...
  function groupBy(df, columnNames) {
    ...
    try {
      for (
        var _iterator2 = df.toCollection(true)[Symbol.iterator](), _step2;
        !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
        _iteratorNormalCompletion2 = true
      ) {
        var row = _step2.value;
        var hash = row.select
          .apply(row, _toConsumableArray(columnNames))
          .hash();
    ...
    var groups = hashes.reduce(function (groups, hash) {
      ...
      groups[hash] = {
        groupKey: (_rowsByGroup$hash$ = rowsByGroup[hash][0]).select
          .apply(_rowsByGroup$hash$, _toConsumableArray(columnNames))
          .toDict(),
        hash: hash,
  ...
  _export(
    { global: true, wrap: true, forced: FORCED$4 },
    {
  ...
  // statics
  _export(
    { target: PROMISE, stat: true, forced: FORCED$4 },
    {
    ...
    on: function (typename, callback) {
      ...
      while (++i < n) {
        if ((t = (typename = T[i]).type))
          _[t] = set$4(_[t], typename.name, callback);
        else if (callback == null)
          for (t in _) _[t] = set$4(_[t], typename.name, null);
      }
  ...
  function toDSV(df) {
    ...
    var csvContent = header
      ? parser.format(df.toCollection(), df[__columns__$1])
  ...
  function fromJSON(pathOrFile) {
    return new Promise(function (resolve) {
      return typeof pathOrFile === 'string'
        ...
        : loadTextFile(pathOrFile, function (txt) {
  ...
  var DataFrame =
    ...
    (function () {
      ...
      function DataFrame(data, columns) {
        ...
        this.options.modules = [].concat(
          _toConsumableArray(DataFrame.defaultModules),
          _toConsumableArray(this.options.modules || [])
        );
        Object.assign.apply(
          Object,
          [this].concat(
      ...
      _createClass(DataFrame, [
        ...
        },
        {
          ...
          value: function _columnsAreEquals(columns) {
            ...
            for (
              var _i = 0, _Object$keys = Object.keys(columns);
        ...
        },
        {
          ...
          value: function _fromDict(dict, columns) {
            return [
              transpose(Object.values(dict)).map(function (row) {
            ...
            return gdf1
              ...
              .map(function (_ref2) {
                ...
                if (gdf2.get(hash)) {
                  ...
                  modifiedGroup = _this2.__newInstance__(
                    combinedGroup,
                    newColumns
                  );
                }
        ...
        },
        {
          ...
          value: function _join(dfToJoin, columnNames, types) {
            ...
            var newColumns = _toConsumableArray(
              new Set(
                [].concat(
                  _toConsumableArray(this.listColumns()),
                  _toConsumableArray(dfToJoin.listColumns())
                )
              )
            );

            var columns = Array.isArray(columnNames)
              ? columnNames
              : [columnNames];
            var gdf = this.groupBy.apply(this, _toConsumableArray(columns));
            var gdfToJoin = dfToJoin.groupBy.apply(
              dfToJoin,
              _toConsumableArray(columns)
            );
            return [this.__newInstance__([], newColumns)]
              .concat(
                _toConsumableArray(
                  iter(
                    [].concat(
        ...
        },
        {
          ...
          value: function toDict() {
            ...
            return Object.assign.apply(
              ...
              [{}].concat(
                _toConsumableArray(
                  Object.entries(this.transpose().toArray()).map(function (
                    _ref3
                  ) {
        ...
        },
        {
          ...
          value: function show() {
            ...
            var token = 0;
            var toShow = [header, Array(header.length).join('-')]
              .concat(
                _toConsumableArray(
                  iter(
                    this[__rows__],
        ...
        },
        {
          ...
          value: function transpose$$1(tranposeColumnNames) {
            var newColumns = [].concat(
              _toConsumableArray(tranposeColumnNames ? ['rowNames'] : []),
              _toConsumableArray(
                _toConsumableArray(Array(this.count()).keys()).reverse()
              )
            );

            var transposedRows = transpose(
              (tranposeColumnNames
                ? this.push(this[__columns__$1])
                : this
              ).toArray()
            );
        ...
        },
        {
          ...
          value: function push() {
            for (
              var _len8 = arguments.length, rows = new Array(_len8), _key8 = 0;
              _key8 < _len8;
              _key8++
            ) {
        ...
        },
        {
          ...
          value: function replace(value, replacement, columnNames) {
            ...
            return this.map(function (row) {
              return (
                columns.length > 0 ? columns : _this4[__columns__$1]
              ).reduce(function (p, n) {
          ...
          value: function distinct(columnName) {
            return this.__newInstance__(
              _defineProperty(
                {},
                columnName,
                _toConsumableArray(new Set(this.toArray(columnName)))
              ),
              [columnName]
            );
          },
        ...
        },
        {
          ...
          value: function select() {
            ...
            return this.__newInstance__(
              this[__rows__].map(function (row) {
        ...
        },
        {
          ...
          value: function withColumn(columnName) {
            ...
            return this.__newInstance__(
              this[__rows__].map(function (row, index) {
                return row.set(columnName, func(row, index));
              }),
              this[__columns__$1].includes(columnName)
                ? this[__columns__$1]
                : [].concat(_toConsumableArray(this[__columns__$1]), [
                    columnName,
                  ])
            );
          },
        ...
        },
        {
          ...
          value: function castAll(typeFunctions) {
            ...
            return this.map(function (row) {
              return new Row(
                row.toArray().map(function (column, index) {
        ...
        },
        {
          ...
          value: function chain$$1() {
            ...
            return this.__newInstance__(
              _toConsumableArray(
                chain.apply(void 0, [this[__rows__]].concat(funcs))
              ),
              this[__columns__$1]
            );
          },
        ...
        },
        {
          ...
          value: function map(func) {
            return this.__newInstance__(
              iter(this[__rows__], function (row, i) {
                return func(row, i);
              }),
              this[__columns__$1]
            );
          ...
          value: function dropDuplicates() {
            ...
            var groupCols =
              columnNames && columnNames.length > 0
                ...
                : this[__columns__$1];
            return this.groupBy
              .apply(this, _toConsumableArray(groupCols))
        ...
        },
        {
          ...
          value: function dropMissingValues(columnNames) {
            ...
            return this.filter(function (row) {
              ...
              try {
                for (
                  var _iterator2 = cols[Symbol.iterator](), _step2;
            ...
            return this.__newInstance__(
              this.reduce(function (p, n) {
                ...
                return Array.isArray(p)
                  ? [].concat(
                      _toConsumableArray(p.slice(index, p.length + 1)),
                      [n],
                      _toConsumableArray(p.slice(0, index))
                    )
                  : [p, n];
              }),
              this[__columns__$1]
          ...
          value: function bisect(percentage) {
            ...
            return [
              this.__newInstance__(
                iter(this.shuffle()[__rows__], function (row) {
                  if (token < nRows) {
                    token++;
                    return row;
                  }
              ...
              this.__newInstance__(restRows, this[__columns__$1]),
            ];
          },
          /**
        ...
        },
        {
          ...
          value: function sortBy(columnNames) {
            ...
            var _missingValuesPosition = ['first', 'last'].includes(
            ...
            if (_columnNames.length > 1) {
              ...
              sortedRows.forEach(function (row) {
                ...
                try {
                  for (
                    var _iterator3 = _columnNames[Symbol.iterator](), _step3;
          ...
          value: function union(dfToUnion) {
            ...
            return this.__newInstance__(
              [].concat(
                ...
                _toConsumableArray(dfToUnion.restructure(this[__columns__$1]))
              ),
              this[__columns__$1]
            );
          },
      ...
      _createClass(Stat, [
        {
          ...
          value: function _castAsNumber(columnName) {
            return this.df
              .withColumn(columnName, function (row) {
        ...
        },
        {
          ...
          value: function sum(columnName) {
            return Number(
              this.df.reduce(function (p, n) {
                return isNumber(n.get(columnName))
        ...
        },
        {
          ...
          value: function add(df) {
            ...
            return this.df.__newInstance__(
              _toConsumableArray(
                iter(
                  Object.keys(_toConsumableArray(this.df)),
                  function (rowKey) {
                ...
                iter(
                  ...
                  function (rowKey) {
                    ...
                    return _toConsumableArray(
                      iter(columns, function (column) {
                        var b = _toConsumableArray(df.transpose())[
                          column
                        ].toArray();
  ...
  function match(value) {
    for (
      var _len = arguments.length,
        cases = new Array(_len > 1 ? _len - 1 : 0),
        _key = 1;
      _key < _len;
      _key++
    ) {
  ...
  function joinHandler(operation, tables, type) {
    var ONKeywordLocation =
      operation.findIndex(function (word) {
    ...
    return function (df) {
      return df.join(
        tables[operation[0]],
        sqlArgsToArray(
          operation.filter(function (word, loc) {
  ...
  var OPERATIONS_HANDLER = {
      ...
      return function (df) {
        return df.filter(function (row) {
          ...
          return operationalTerms
            .map(function (operationalTerm) {
              var operatorToApply = xContains.apply(
                void 0,
                [operationalTerm].concat(
                  _toConsumableArray(Object.keys(WHERE_OPERATORS))
                )
              )[0];
              var terms = operationalTerm
    ...
    GROUPBY: function GROUPBY(operation) {
      return function (df) {
        return df.groupBy.apply(
          df,
          _toConsumableArray(sqlArgsToArray(operation))
        );
      };
    },
  };
  ...
  function parseOperations(operations, tables) {
    var operationsLoc = operations
      .map(function (word, index) {
        return Object.keys(OPERATIONS_HANDLER).includes(word.toUpperCase())
          ? index
          : undefined;
      })
      .filter(function (loc) {
  ...
  function parseSelections(selections) {
    ...
    return match(
      ...
      [
        function (value) {
          return xContains.apply(
            void 0,
            [value[0].toUpperCase()].concat(
              _toConsumableArray(Object.keys(SELECT_FUNCTIONS))
            )
          )[0];
        },
        function (value) {
          return function (df) {
            var functionToApply = Object.keys(SELECT_FUNCTIONS).find(function (
              func
            ) {
            ...
            var applyFunction = function applyFunction(dfToImpact) {
              return SELECT_FUNCTIONS[functionToApply](
                ...
                xReplace(
                  value[0],
                  [''.concat(functionToApply.toLowerCase(), '('), ''],
                  [''.concat(functionToApply, '('), ''],
                  ['(', ''],
                  [')', '']
                )
              );
